const Settings = {
  ...
  LOCATION_DB: {
    ...
    "ראשון לציון": { lat: 31.9590, lng: 34.8025 },
    "פתח תקווה":   { lat: 32.0871, lng: 34.8877 },
    "חדרה":        { lat: 32.4414, lng: 34.9030 },
    ...
    "גליל עליון":  { lat: 33.078, lng: 35.589 },
    "ים המלח":     { lat: 31.5388, lng: 35.3978 },
    "ערבה":        { lat: 30.3840, lng: 35.1900 },
    "נגב":         { lat: 30.7630, lng: 34.7420 },
